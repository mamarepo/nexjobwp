        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/jobs" className="text-gray-400 hover:text-white transition-colors">Cari Lowongan</a></li>
              <li><a href="/articles" className="text-gray-400 hover:text-white transition-colors">Tips Karir</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/articles" className="text-gray-400 hover:text-white transition-colors">Blog</a></li>
